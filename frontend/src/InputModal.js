        ...
        <>
            <Modal isOpen={isOpen} onRequestClose={onRequestClose} className="modal" overlayClassName="overlay">
                ...
                <form className="form-container" onSubmit={handleSubmit}>
                    ...
                    <input name="startTime" type="text" value={startTime} onChange={handleChange}/>
                    ...
                    <input name="endTime" type="text" value={endTime} onChange={handleChange}/>
                    ...
                    <input name="subject" type="text" value={subject} onChange={handleChange}/>
